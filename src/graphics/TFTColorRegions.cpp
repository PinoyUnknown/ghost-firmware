...
static constexpr const char *kDefaultThemeName = "Ghost";
static constexpr uint16_t kDefaultAccent = TFTPalette::GhostCyan;
static constexpr uint16_t kDefaultHighlight = TFTPalette::GhostYellow;
#else
static constexpr const char *kDefaultThemeName = "Default Dark";
static constexpr uint16_t kDefaultAccent = TFTPalette::Good;
static constexpr uint16_t kDefaultHighlight = TFTPalette::Yellow;
#endif
...
static const TFTThemeDef kThemes[] = {
    ...
    // Default Dark (ThemeID::DefaultDark = 0)
    {
        ...
        kDefaultThemeName,    // name
        0,                    // uniqueIdentifier
        // roles[TFTColorRole::Count]
        {
            {kDefaultAccent, TFTPalette::Black},       // HeaderBackground
            {kDefaultAccent, kDefaultHighlight},        // HeaderTitle
            {kDefaultAccent, kDefaultAccent},           // HeaderStatus
            {kDefaultAccent, TFTPalette::Black},        // SignalBars
            {kDefaultHighlight, TFTPalette::Black},     // ConnectionIcon
            {kDefaultAccent, TFTPalette::Black},        // UtilizationFill
            {kDefaultHighlight, TFTPalette::Black},     // FavoriteNode
            {kDefaultHighlight, TFTPalette::Black},     // ActionMenuBorder
            {TFTPalette::White, TFTPalette::Black},    // ActionMenuBody
            {kDefaultHighlight, TFTPalette::Black},    // ActionMenuTitle
            {TFTPalette::Black, kDefaultAccent},        // FrameMono
            {kDefaultAccent, TFTPalette::Black},        // BootSplash
            {kDefaultHighlight, TFTPalette::Black},     // FavoriteNodeBGHighlight
            {kDefaultHighlight, TFTPalette::Black},    // NavigationBar  (icon fg, bar bg)
            {kDefaultAccent, TFTPalette::Black},       // NavigationArrow (arrow fg, body bg)
        },
        kDefaultAccent,     // batteryFillGood
        kDefaultHighlight,  // batteryFillMedium
...
static TFTRoleColorsBe roleColors[static_cast<size_t>(TFTColorRole::Count)] = {
    {toBe565(kDefaultAccent), toBe565(TFTPalette::Black)},       // HeaderBackground
    {toBe565(kDefaultAccent), toBe565(kDefaultHighlight)},       // HeaderTitle
    {toBe565(kDefaultAccent), toBe565(kDefaultAccent)},          // HeaderStatus
    {toBe565(kDefaultAccent), toBe565(TFTPalette::Black)},        // SignalBars
    {toBe565(kDefaultHighlight), toBe565(TFTPalette::Black)},    // ConnectionIcon
    {toBe565(kDefaultAccent), toBe565(TFTPalette::Black)},        // UtilizationFill
    {toBe565(kDefaultHighlight), toBe565(TFTPalette::Black)},    // FavoriteNode
    {toBe565(kDefaultHighlight), toBe565(TFTPalette::Black)},    // ActionMenuBorder
    {toBe565(TFTPalette::White), toBe565(TFTPalette::Black)},    // ActionMenuBody
    {toBe565(kDefaultHighlight), toBe565(TFTPalette::Black)},   // ActionMenuTitle
    {toBe565(TFTPalette::Black), toBe565(kDefaultAccent)},        // FrameMono
    {toBe565(kDefaultAccent), toBe565(TFTPalette::Black)},        // BootSplash
    {toBe565(kDefaultHighlight), toBe565(TFTPalette::Black)},    // FavoriteNodeBGHighlight
    {toBe565(kDefaultHighlight), toBe565(TFTPalette::Black)},    // NavigationBar
    {toBe565(kDefaultAccent), toBe565(TFTPalette::Black)}        // NavigationArrow
};
